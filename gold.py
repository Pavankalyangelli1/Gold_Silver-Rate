...
def fetch_prices():
    gold_usd = yf.Ticker("GOLDBEES.NS").history(period="1d")["Close"].iloc[-1]
    silver_usd = yf.Ticker("SILVERBEES.NS").history(period="1d")["Close"].iloc[-1]
...
while True:
    try:
        ...
        print(f"Vijayawada Silver Jewellery Est: ₹{Vijayawada_silver:.2f} /kg")
        ...
        data = {
            ...
            "Vijayawada_22K_Est": round(Vijayawada,2),
