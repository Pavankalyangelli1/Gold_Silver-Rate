...
def fetch_prices():
    ...
    gold_per_gram = gold_inr / 31.1035
    silver_per_gram = silver_inr / 31.1035

    gold_24k_10g = gold_per_gram * 10
    gold_22k_10g = gold_24k_10g * 0.916   # 22K purity
    silver_per_kg = silver_per_gram * 1000

    # Chennai jewellery estimation (approx)
    making_charge = 12  # %
    silver_making = 8  # %
    gst = 3  # %
    chennai_22k = gold_22k_10g * (1 + making_charge/100)
    chennai_22k = chennai_22k * (1 + gst/100)

    # Silver jewellery estimation (₹ per kg)
    chennai_silver = silver_per_kg * (1 + silver_making/100)
    chennai_silver = chennai_silver * (1 + gst/100)

    return gold_24k_10g, gold_22k_10g, silver_per_kg, chennai_22k, chennai_silver
...
while True:
    try:
        gold24, gold22, silver, chennai = fetch_prices()
        ...
        print(f"Chennai Est 22K Jewellery: ₹{chennai:.2f} /10g")
        print(f"Chennai Silver Jewellery Est: ₹{chennai_silver:.2f} /kg")
        ...
        data = {
            ...
            "Chennai_22K_Est": round(chennai,2)
